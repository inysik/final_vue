<template>
    ...
    <swiper
      ...
      class="mySwiper"
    >
      <swiper-slide v-for="(file, index) in swiperFiles" :key="index">
  ...
  export default {
    ...
    setup() {
      ...
      return {
        ...
        swiperFiles: store.getters.getSwiperFiles,
      };
    },
  };
